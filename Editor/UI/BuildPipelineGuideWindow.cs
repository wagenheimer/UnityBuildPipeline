...
namespace Wagenheimer.BuildPipeline.Editor
{
    internal class BuildPipelineGuideWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Wagenheimer/Build Pipeline/Documentation & Integration Guide", priority = 20)]
        ...
        void OnGUI()
        {
            ...
            DrawCard(1, "Two-Tier Architecture (Build vs Runtime)",
                ...
                "• ProjectBuildConfig.asset (Editor): Stores paths, keystores, publisher definitions, and matrix presets. Has NO version/build-number fields — it only holds a reference to your GameConfig. Never shipped in builds.\n" +
                "• GameConfig.asset (Runtime, e.g. \"YourGame.asset\"): The single SOURCE OF TRUTH for GameVersion, AndroidBundleVersionCode and iOSBuildNumber. Kept in your project and referenced by MainBase.cs. Automatically synchronized before every build with the active publisher, language, version, and cheat mode.\n\n" +
            ...
            DrawCard(4, "Language & Publisher Matrix Batch Builder",
            ...
            DrawCard(5, "100% Headless Unity CLI Automation",
            ...
            DrawCard(6, "Automated PowerShell Script (build.ps1)",
            ...
            DrawCard(7, "Post-Processing Lifecycle & Archiving",
            ...
            DrawCard(8, "Remote Keystore Vault & Credentials Security",
            ...
            DrawCard(9, "Android Auto-Run & Logcat Integration",
            ...
            DrawCard(10, "Extensible Lifecycle Hooks",
            ...
            DrawCard(11, "1-Click Migration Wizard for Other Projects",
